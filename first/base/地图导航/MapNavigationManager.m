...
- (void)showSheet
{
    ...
    UIAlertController *alertVC = [UIAlertController alertControllerWithTitle:@"请选择您已经安装的导航工具" message:nil preferredStyle:UIAlertControllerStyleActionSheet];
    ...
    UIAlertAction *gaodeAction = [UIAlertAction actionWithTitle:gaodeMap style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        
    }];
    UIAlertAction *appleAction = [UIAlertAction actionWithTitle:appleMap style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        
    }];
    UIAlertAction *baiduAction = [UIAlertAction actionWithTitle:baiduMap style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        
    }];
    UIAlertAction *tencentAction = [UIAlertAction actionWithTitle:tencentMap style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
        
    }];
    UIAlertAction *googleAction = [UIAlertAction actionWithTitle:googleMap style:UIAlertActionStyleDefault handler:^(UIAlertAction * _Nonnull action) {
